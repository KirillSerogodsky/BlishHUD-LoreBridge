...
public class SettingsModel(SettingCollection settings)
{
    ...
    public readonly SettingEntry<KeyBinding> ToggleTranslationWindowHotKey = settings.DefineSetting("Hotkeys.ToggleTranslationWindow",
        new KeyBinding(),
        () => "Toggle translation window",
        () => "Not implemented");

    public readonly SettingEntry<int> TranslationLanguage = settings.DefineSetting("Translation.Language", (int)Languages.Russian);
    public readonly SettingEntry<int> TranslationTranslator = settings.DefineSetting("Translation.Translator", (int)Translators.Google2);
