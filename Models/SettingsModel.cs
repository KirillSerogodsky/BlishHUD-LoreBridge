...
public class SettingsModel(SettingCollection settings)
{
    ...
    public readonly SettingEntry<string> TranslationLibreTranslateUrl =
        settings.DefineSetting("Translation.Translator.LibreTranslate.Url", "");
    ...
    public readonly SettingEntry<KeyBinding> ToggleCapturerHotkey =
        settings.DefineSetting("Hotkeys.ToggleCapturer", new KeyBinding(), () => "Select translation area");
