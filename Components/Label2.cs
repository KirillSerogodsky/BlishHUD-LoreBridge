...
public class Label2 : LabelBase2
{
    ...
    public string Text
    {
        ...
        set
        {
            if (SetProperty(ref _text, value, true) && (_autoSizeWidth || _autoSizeHeight)) RecalculateLayout();
        }
    }
    ...
    public SpriteFontBase Font
    {
        ...
        set
        {
            if (SetProperty(ref _font, value, true) && (_autoSizeWidth || _autoSizeHeight)) RecalculateLayout();
        }
    }
